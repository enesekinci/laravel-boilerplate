...
function layout_sidebar_change(value) {
    ...
    localStorage.setItem('theme_contrast', value);
...
function layout_caption_change(value) {
    ...
    localStorage.setItem('caption_show', value);
...
function preset_change(value) {
    ...
    localStorage.setItem('preset_theme', value);
...
function layout_rtl_change(value) {
    ...
    localStorage.setItem('rtl_layout', value);
...
function change_box_container(value) {
    localStorage.setItem('box_container', value);
