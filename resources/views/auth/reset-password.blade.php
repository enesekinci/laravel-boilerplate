<x-auth.guest>
    <form method="POST" action="{{ route('password.store') }}">
        ...
        <!-- Password -->
        <div class="mt-4">
            <x-dashboard.form.input.label for="password" :value="__('Password')" />
        ...
        <div class="mt-4">
            ...
            <x-auth.text-input id="password_confirmation" class="block mt-1 w-full" type="password" name="password_confirmation" required autocomplete="new-password" />
