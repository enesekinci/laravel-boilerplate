             ...
             <ul class="list-unstyled">
                 ...
                 <li class="dropdown pc-h-item header-user-profile">
                     <a class="pc-head-link dropdown-toggle arrow-none me-0" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" data-bs-auto-close="outside"
                         aria-expanded="false">
                         <img src="/theme/dashboard/assets/images/user/avatar-2.jpg" alt="user-image" class="user-avtar" />
                     </a>
                         ...
                         <div class="dropdown-body">
                             <div class="profile-notification-scroll position-relative" style="max-height: calc(100vh - 225px)">
                                 <div class="d-flex mb-1">
                                     <div class="flex-shrink-0">
                                         <img src="/theme/dashboard/assets/images/user/avatar-2.jpg" alt="user-image" class="user-avtar wid-35" />
                                     </div>
                                     <div class="flex-grow-1 ms-3">
                                 ...
                                 <a href="#" class="dropdown-item">
                                     ...
                                     <div class="user-group">
                                         <img src="/theme/dashboard/assets/images/user/avatar-1.jpg" alt="user-image" class="avtar" />
                                 ...
                                 <div class="card border-0 shadow-none drp-upgrade-card mb-0" style="background-image: url(theme/dashboard/assets/images/layout/img-profile-card.jpg)">
                                     <div class="card-body">
                                         <div class="user-group">
                                             <img src="/theme/dashboard/assets/images/user/avatar-1.jpg" alt="user-image" class="avtar" />
                                             <img src="/theme/dashboard/assets/images/user/avatar-2.jpg" alt="user-image" class="avtar" />
                                             <img src="/theme/dashboard/assets/images/user/avatar-3.jpg" alt="user-image" class="avtar" />
                                             <img src="/theme/dashboard/assets/images/user/avatar-4.jpg" alt="user-image" class="avtar" />
                                             <img src="/theme/dashboard/assets/images/user/avatar-5.jpg" alt="user-image" class="avtar" />
